...
import edu.zju.gis.zyq.loader.GdbLoader;
...
public class GdbLoaderExample {
    ...
    public static void main(String[] args) {
        ...
        GdbLoader gdbLoader = new GdbLoader();
        gdbLoader.initialize(addr, database, schema, username, password);
        gdbLoader.load(path, layerName, tableName);
        gdbLoader.close();
