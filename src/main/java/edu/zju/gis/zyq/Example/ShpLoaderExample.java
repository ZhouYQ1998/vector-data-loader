...
import edu.zju.gis.zyq.loader.ShpLoader;
...
public class ShpLoaderExample {
    ...
    public static void main(String[] args) {
        ...
        shpLoader.initialize(addr, database, schema, username, password);
        shpLoader.load(path, layerName, tableName);
        shpLoader.close();
