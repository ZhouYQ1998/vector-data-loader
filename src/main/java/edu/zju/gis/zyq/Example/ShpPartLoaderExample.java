...
import edu.zju.gis.zyq.loader.ShpPartLoader;
 ...
 */
public class ShpPartLoaderExample {
    ...
    public static void main(String[] args) {
        ...
        ShpPartLoader shpPartLoader = new ShpPartLoader();
        shpPartLoader.initialize(addr, database, schema, username, password, partNum);
        shpPartLoader.load(path, layerName, tableName);
        shpPartLoader.close();
