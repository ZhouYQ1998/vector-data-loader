...
public class GdbLoader {
    ...
    public void initialize(String addr, String database, String schema, String username, String password) {
        ...
        this.ss = SparkSession.builder().config(conf).master("local[*]").appName("GdbLoader").getOrCreate();
    ...
    public void load(String path, String layerName, String tableName) {
        ...
        StructType schema = SchemaHelper.getSchema(colNames, types);
        ...
        Dataset<Row> df = this.ss.createDataFrame(rdd, schema);
